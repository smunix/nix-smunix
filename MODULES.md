...
| Fingerprint authentication | `modules.security.fingerprint.enable` | Enables fprintd and scoped fingerprint PAM authentication for interactive login, unlock, and privilege prompts while explicitly excluding password/account mutation and noninteractive services. YubiKey and password fallback remain available. |
